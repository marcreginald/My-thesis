...
class Ciqrcode
{
	...
	function __construct($config = array()) {
		...
		include "assets/makeqr/qrcode/qrconst.php";
		include "assets/makeqr/qrcode/qrtools.php";
		include "assets/makeqr/qrcode/qrspec.php";
		include "assets/makeqr/qrcode/qrimage.php";
		include "assets/makeqr/qrcode/qrinput.php";
		include "assets/makeqr/qrcode/qrbitstream.php";
		include "assets/makeqr/qrcode/qrsplit.php";
		include "assets/makeqr/qrcode/qrrscode.php";
		include "assets/makeqr/qrcode/qrmask.php";
		include "assets/makeqr/qrcode/qrencode.php";
